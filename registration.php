...
if (isset($_POST['reg_user'])) {
  ...
  if (empty( $password_1)) { array_push($errors, "Password 1 is required"); }
  if (empty( $password_2)) { array_push($errors, "Password 2 is required"); }
  ...
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO registration (fname,lname,email,username,password) 
  			  VALUES('$first_name', '$last_name','$email','$username', '$password_1')";
